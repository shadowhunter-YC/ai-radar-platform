...
export const OFFICIAL_PRESET_FEEDS = [
  ...
  },
  {
    ...
    category: '头部厂商',
    description: '谷歌安全团队官方技术博客（已配置关键词筛选）',
  ...
  },
  {
    ...
    category: '头部厂商',
    description: '微软安全与合规团队官方博客（已配置关键词筛选）',
  ...
  },
  {
    ...
    name: '量子位',
    url: 'https://wewe.wilsongo.top/feeds/all.rss?account=qbit',
    category: '微信公众号',
  ...
  {
    id: 'preset-wechat-cac',
    name: '网信中国',
    url: 'https://wewe.wilsongo.top/feeds/all.rss?account=cac',
    category: '微信公众号',
    description: '国家互联网信息办公室官方发布（AI算法备案、数据安全与政策监管）',
    filterKeywords: '人工智能, 大模型, 算法, 备案, 数据安全, 网络安全, 合规, 治理, 深度合成, 科技伦理',
    enabled: 1,
    cadence: '每天'
  },
  {
    id: 'preset-wechat-zhidx',
    name: '智东西',
    url: 'https://wewe.wilsongo.top/feeds/all.rss?account=zhidx',
    category: '微信公众号',
    description: '大模型落地、算力与AI产业深度报告（已配置关键词筛选）',
    filterKeywords: 'AI, 大模型, 模型, 安全, 监管, 合规, 算力, 评测, 漏洞, Agent',
    enabled: 1,
    cadence: '每天'
  }
];
